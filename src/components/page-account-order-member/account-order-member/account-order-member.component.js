angular.module('kidztimeApp')
    .component('accountOrderMember', {
        templateUrl: '/dist/components/page-account-order-member/account-order-member/account-order-member.component.html',
        bindings: {},
        controller: [
            '$scope',
            function($scope) {
                                ...
                                items: [
                                    {
                                        ...
                                        accessory: {
                                            ...
                                            visibleItemsCount: 4,
                                            singleSelectMode: false,
                                            selectedItemsIndexes: [0, 0, 0, 0, 0, 0],
                                            availableItems: [
                                                {
                                                    title: '3INI Melamine Cutlery Set (Chopstics) Crime Fighter',
                                                    image: '../../../../img/cart-product-item-poster.png',
                ...
                $scope.loadMoreHistory = () => {
                    ...
                    $scope.historyList.push(...loadedItems);
                }
            }]
    });
